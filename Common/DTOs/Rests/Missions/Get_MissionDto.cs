...
namespace Common.DTOs.Rests.Missions
{
    public class Get_MissionDto
    {
        ...
        [JsonPropertyOrder(2)] public DateTime createdAt { get; set; }                  // 생성 시각
        [JsonPropertyOrder(3)] public DateTime? updatedAt { get; set; }
        [JsonPropertyOrder(4)] public DateTime? finishedAt { get; set; }
        [JsonPropertyOrder(5)] public bool enteredZoneOnce { get; set; }
        ...
        [JsonPropertyOrder(14)] public int sequence { get; set; }                   //현재 명령의 실행 순서 이 값은 실행 전 재정렬에 따라 변경될 수 있음
        ...
        [JsonPropertyOrder(22)] public List<Parameter> parameters { get; set; }
        [JsonPropertyOrder(23)] public List<PreReport> preReports { get; set; }
        [JsonPropertyOrder(24)] public List<PostReport> postReports { get; set; }
